...
public class BigConstants {
    ...
    public static final BigDecimal TEN = BigDecimal.val(10.0);
    ...
    public static final BigDecimal FIND_BITS = BigDecimal.val(1.0000001);
    ...
    public static final BigDecimal EPSILON = BigDecimal.val(1.0E-7);
    public static final BigDecimal NEG_EPSILON = BigDecimal.val(-1.0E-7);
    public static final BigDecimal ENTITY = BigDecimal.val(1.0E-6D);
    public static final BigDecimal AABB = BigDecimal.val(0.5);
    ...
    public static final BigDecimal EIGHT = BigDecimal.val(8.0);
    public static final BigDecimal VAL = BigDecimal.val(0.33F);
    public static final BigDecimal TWELVE = BigDecimal.val(12.0D);
    public static final BigDecimal SIXTEEN = BigDecimal.val(16.0);
    ...
    public static final BigDecimal OCCLUSION = BigDecimal.val(3600.0);

    public static class Ints {
        public static final BigInteger REALLY_BIG_NUMBER = new BigInteger("9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999");
        // Who cares if this isn't really "small"
        public static final BigInteger REALLY_SMALL_NUMBER = new BigInteger("-9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999");
